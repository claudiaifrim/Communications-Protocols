...
#seteaza protocolul de rutare sa fie distance-vector 
#(daca am comenta aceasta linie se foloseste protocolul static,
# care este default)
$ns rtproto DV
...
$ns duplex-link $n3 $n0 100Kb 100ms DropTail
$ns duplex-link $n4 $n0 100Kb 100ms DropTail
$ns duplex-link $n5 $n0 100Kb 100ms DropTail
$ns duplex-link $n6 $n2 100Kb 100ms DropTail
